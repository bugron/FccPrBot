 ...
 */
module.exports = async function forbiddenBaseBranch(repoConfig, data) {
  if (
    repoConfig.rules.critical.forbiddenBaseBranchPatterns &&
    repoConfig.rules.critical.forbiddenBaseBranchPatterns
      .includes(data.pull_request.base.ref)
  ) {
    return {
